...
allowed, which is 3.
Step 4: Create a function called checkInput that takes in an event as a parameter. On our HTML page, 
...
value.
Step 6: Define a variable called messageDisp with the selection of a p element in out HTML file
...
Step 13: Create a button element and store it in a variable called resetBtn. This button will not be displayed
until the resetButton gets executed.
Step 14: Create a function called resetGame that will generate a new random number and will
reset the numberOfSub variable to its initial value of 1, will clear out the displayed messages using an empty
string, will enable the use of the submit button (which will be disabled in the next function), and will hide the
button element that will be created in the resetButton function.
Step 15: Create the function called resetButton that will display the resetBtn, and will make the resetBtn execute the 
